//
//  TalkingTomViewController.swift
//  Media
//
...
class TalkingTomViewController: UIViewController {
    ...
    @IBAction func onCatAngry(_ sender: UIButton) {
    ...
    @IBAction func onCatBlink(_ sender: UIButton) {
    ...
    @IBAction func onCatCymbal(_ sender: UIButton) {
    ...
    @IBAction func onCatDrink(_ sender: UIButton) {
    ...
    @IBAction func onCatEat(_ sender: UIButton) {
    ...
    @IBAction func onCatZeh(_ sender: UIButton) {
    ...
    @IBAction func onCatTalk(_ sender: UIButton) {
    ...
    @IBAction func onCatStomach(_ sender: UIButton) {
    ...
    @IBAction func onCatSneeze(_ sender: UIButton) {
    ...
    @IBAction func onCatScratch(_ sender: UIButton) {
    ...
    @IBAction func onCatPie(_ sender: UIButton) {
    ...
    @IBAction func onCatListen(_ sender: UIButton) {
    ...
    @IBAction func onCatKnockOut(_ sender: UIButton) {
    ...
    @IBAction func onCatFart(_ sender: UIButton) {
    ...
    @IBAction func onCatFootLeft(_ sender: UIButton) {
    ...
    @IBAction func onCatHappy(_ sender: UIButton) {
